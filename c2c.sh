...
config2class to-code --input config/training/train_sb_sac.yaml --output project/utils/configs/train_sb_sac_config.py --init-none
...
config2class to-code --input config/training/train_er_dyna.yaml --output project/utils/configs/train_er_dyna_config.py --init-none
